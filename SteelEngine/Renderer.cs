...
namespace SteelEngine
{
    ...
    public static class Renderer
    {
        ...
        private static Shader? TextureShaderProgram;
        ...
        public static void Initialize(int screenWidth, int screenHeight)
        {
            ...
            TextureShaderProgram = new Shader("resources/shaders/texture.vert", "resources/shaders/texture.frag");
        ...
        public static void DrawText(string text, Font font, Point point, Lua.Color? color)
        {
            color = color == null ? Lua.Color.White : color;
            ...
            graphics.DrawString(text, font, Brushes.White, point);
            ...
            DrawTexturedPoly(vertices, texCoords, texture, color);
        }
